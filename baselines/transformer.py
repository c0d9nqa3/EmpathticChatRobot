...
class Generator(nn.Module):
    ...
    def forward(self, x, attn_dist=None, enc_batch_extend_vocab=None, max_oov_length=None, temp=1, beam_search=False,
                attn_dist_db=None):
...
class Transformer(nn.Module):
    ...
    def train_one_batch(self, batch, iter, train=True):
        ...
        logit = self.generator(pre_logit, attn_dist, enc_ext_batch if False else None, max_oov_length,
                               attn_dist_db=None)
    ...
    def decoder_topk(self, batch, max_dec_step=30):
        ...
        mask_src = enc_batch.data.eq(1).unsqueeze(1)
